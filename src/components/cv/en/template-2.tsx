      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:col-span-5 bg-[#6B7B6A] text-white relative min-h-screen lg:min-h-0">
          ...
          <div className="relative z-10 p-10 pt-16">
            ...
            <h1 className="text-5xl font-bold leading-tight mt-20">En Temp2</h1>
            <p className="text-2xl mt-3 opacity-90">ULTRICIES TURPIS AC PROIN ULLAMCORPER</p>
            <p className="mt-8 text-sm leading-relaxed max-w-xs">
              Creative and passionate interior designer, specializing in transforming living and working spaces into unique experiences. Passionate about coordinating colors, lighting, and materials to create spaces that are both visually appealing and functional.
            </p>
