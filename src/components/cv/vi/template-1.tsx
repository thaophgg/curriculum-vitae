      ...
      <header className="relative bg-white overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between px-12 pt-24 pb-16">
          <div className="mt-8 md:mt-0 text-center md:text-left max-w-lg">
            <h1 className="text-6xl font-black leading-none">Vi Temp1</h1>
            <p className="text-3xl text-red-600 font-light mt-4">CHUYÊN VIÊN PHÁT TRIỂN KINH DOANH</p>
            <p className="mt-8 text-gray-700 text-sm leading-relaxed">
              Chuyên viên kinh doanh năng động với hơn 5 năm kinh nghiệm trong lĩnh vực bán hàng B2B, phát triển khách hàng và chăm sóc quan hệ khách hàng. Thành tích nổi bật trong việc mở rộng danh mục khách hàng mới, tăng trưởng doanh thu bền vững và nâng cao tỷ lệ giữ chân khách hàng. Hiện đang tìm kiếm cơ hội mới để phát triển sự nghiệp.
            </p>
          </div>
        </div>
      </header>
